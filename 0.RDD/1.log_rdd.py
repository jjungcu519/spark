...
file_path = '/home/ubuntu/dmf/spark/0.RDD/access.log'
...
filtered_pp = mapped_lines.filter(filter_post_product)
# filtered_pp.foreach(print)
...
# 4. groupby
# -1. status code, api method별 ip리스트 출력
